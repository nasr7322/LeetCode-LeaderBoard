      ...
      <table className="min-w-full bg-leetcode-dark text-leetcode-text">
        <thead className="border-b border-gray-800">
          <tr>
            ...
            <th className="px-6 py-3 cursor-pointer" onClick={() => handleSort('totalSolved')}>
            ...
            <th className="px-6 py-3 cursor-pointer" onClick={() => handleSort('ranking')}>
              <div className="flex items-center gap-2">
                <Target size={16} />
                Global Ranking
                <ArrowUpDown size={16} className="opacity-50" />
            ...
            <th className="px-6 py-3 cursor-pointer" onClick={() => handleSort('acceptanceRate')}>
              <div className="flex items-center gap-2">
                <Zap size={16} />
                Acceptance Rate
                <ArrowUpDown size={16} className="opacity-50" />
        ...
        <tbody className="divide-y divide-gray-800">
          {sortedData.map((user, index) => (
            <tr key={user.username} className="hover:bg-gray-800/50">
              ...
              <td className="px-6 py-4">{user.ranking.toLocaleString()}</td>
              <td className="px-6 py-4">{user.acceptanceRate.toFixed(1)}%</td>
              <td className="px-6 py-4">
                <div className="flex gap-2 text-sm">
                  <span className="text-leetcode-easy">E: {user.easySolved}</span>
